...
import pl.put.poznan.sortingmadness.logic.BubbleSorter;
...
class BubbleSorterTest {
    BubbleSorter mockBubbleSorter = null;
    ...
    public void setup() throws JSONException {
        mockBubbleSorter = mock(BubbleSorter.class);
    ...
    public void testSortAscendingObjects() throws JSONException {
        mockBubbleSorter.sort(mockListObjects,
                -1,
                true,
                new JSONComparator(new ArrayList<>(Collections.singleton("id"))));
        verify(mockBubbleSorter, times(1)).sort(
    ...
    public void testSortAscendingSimple() {
        mockBubbleSorter.sort(mockList, -1, true);
        verify(mockBubbleSorter, times(1)).sort(
    ...
    public void testSortDescendingSimple() {
        mockBubbleSorter.sort(mockList, -1, false);
        verify(mockBubbleSorter, times(1)).sort(
                anyListOf(Comparable.class),
                isA(Integer.class),
                isA(Boolean.class));
